...
const app = createOpsServer({
  ...
  agentRuntimeX64Path: process.env.OPS_AGENT_RUNTIME_X64_PATH,
  agentRuntimeArm64Path: process.env.OPS_AGENT_RUNTIME_ARM64_PATH,
  bootstrapMaxConcurrent: Number(process.env.OPS_BOOTSTRAP_MAX_CONCURRENT ?? 2),
  bootstrapTimeoutMs: Number(process.env.OPS_BOOTSTRAP_TIMEOUT_MS ?? 600_000),
